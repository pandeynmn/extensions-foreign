...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.NineMangaDE = exports.NineMangaDEInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
...
exports.NineMangaDEInfo = {
    ...
    language: paperback_extensions_common_1.LanguageCode.DUTCH,
...
class NineMangaDE extends NineManga_1.NineManga {
    constructor() {
        super(...arguments);
        this.baseUrl = DE_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.DUTCH;
        this.genreTag = 'Genre (s)';
        this.authorTag = 'Autor (en)';
...
exports.NineMangaDE = NineMangaDE;
