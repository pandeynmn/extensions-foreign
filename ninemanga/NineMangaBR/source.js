...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.NineMangaBR = exports.NineMangaBRInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const NineManga_1 = require("../NineManga");
const BR_DOMAIN = 'https://br.ninemanga.com';
exports.NineMangaBRInfo = {
    ...
    language: paperback_extensions_common_1.LanguageCode.BRAZILIAN,
...
class NineMangaBR extends NineManga_1.NineManga {
    constructor() {
        super(...arguments);
        this.baseUrl = BR_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.DUTCH;
        this.genreTag = 'Gênero';
        this.authorTag = 'Autor';
...
exports.NineMangaBR = NineMangaBR;
